...
#docker run -d --name="6e858862-703f-452d-889c-5d8cd03793b9" --cidfile="6e858862-703f-452d-889c-5d8cd03793b9.dockerid" -v /scratch/data/samir/pcawg/v3_htseq:$MYWORKDIR -e MYWORKDIR=$MYWORKDIR -e USER=$USER -e USERID=$UID -w=$MYWORKDIR pcawg14/htseq:0.9.2 /bin/bash -c "source ${MYWORKDIR}/set_env/bash_profile && source ${MYWORKDIR}/htseq_docker_geneid.sh "rnaseq.gc19_extNc.gtf" "6e858862-703f-452d-889c-5d8cd03793b9" "PCAWG.4588e050-e15f-476f-9065-ba747bdd3736.STAR.v1.bam" | tee -a ${MYWORKDIR}/htseq_docker.log"
